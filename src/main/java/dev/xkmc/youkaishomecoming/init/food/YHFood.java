...
public enum YHFood implements ItemLike {
	...
	RAW_BOARCHOP(FoodType.MEAT, 4, 0.3f,
			YHTagGen.RAW_BOAR, DietTagGen.PROTEINS.tag
	),
	GRILLED_BOARCHOP(FoodType.MEAT, 10, 0.8f,
			YHTagGen.COOKED_BOAR, DietTagGen.PROTEINS.tag
	),
	RAW_BOARCHOP_BITS(FoodType.MEAT_SLICE, 2, 0.3f,
			YHTagGen.RAW_BOAR, DietTagGen.PROTEINS.tag
	),
	GRILLED_BOARCHOP_BITS(FoodType.MEAT_SLICE, 6, 0.8f,
			YHTagGen.COOKED_BOAR, DietTagGen.PROTEINS.tag
	),
	...
	RAISIN(FoodType.FAST, 3, 0.6f, DietTagGen.FRUITS.tag),
	...
	KOISHI_MOUSSE(FoodType.SIMPLE, 8, 0.6f, List.of(
			new EffectEntry(GLEffects.UNCONSCIOUS, 400, 0, 1)
	), DietTagGen.SUGARS.tag),
	...
	GREEN_TEA(YHDrink.GREEN_TEA),
	WHITE_TEA(YHDrink.WHITE_TEA),
	BLACK_TEA(YHDrink.BLACK_TEA),
	OOLONG_TEA(YHDrink.OOLONG_TEA),
	CORNFLOWER_TEA(YHDrink.CORNFLOWER_TEA),
	TEA_MOCHA(YHDrink.TEA_MOCHA),
	SAIDI_TEA(YHDrink.SAIDI_TEA),
	SAKURA_HONEY_TEA(YHDrink.SAKURA_HONEY_TEA),
	GENMAI_TEA(YHDrink.GENMAI_TEA),
	GREEN_WATER(YHDrink.GREEN_WATER),
	...
	HAN_PALACE(FoodType.BOWL_MEAT, 12, 0.8f, List.of(
			new EffectEntry(ModEffects.NOURISHMENT, 3600, 0, 1),
			new EffectEntry(ModEffects.COMFORT, 3600, 0, 1),
			new EffectEntry(MobEffects.NIGHT_VISION, 3600, 0, 1)
	), DietTagGen.PROTEINS.tag, DietTagGen.VEGETABLES.tag),
	TOFU_CRAB_STEW(FoodType.BOWL_MEAT, 12, 0.8f, List.of(
			new EffectEntry(ModEffects.NOURISHMENT, 3600, 0, 1),
			new EffectEntry(ModEffects.COMFORT, 3600, 0, 1),
			new EffectEntry(YHEffects.CRABY, 3600, 0, 1)
	), DietTagGen.PROTEINS.tag, DietTagGen.VEGETABLES.tag),
	...
	YHFood(YHDrink delegate) {
		this.type = FoodType.BOTTLE;
		this.item = delegate.item;
	}
