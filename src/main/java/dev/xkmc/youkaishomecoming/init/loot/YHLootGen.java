...
public class YHLootGen {
	...
	/*
	public static final ResourceLocation NEST_CHEST = GensokyoLegacy.loc("chests/youkai_nest/chest");
	public static final ResourceLocation NEST_BARREL = GensokyoLegacy.loc("chests/youkai_nest/barrel");
	public static final ResourceLocation SHRINE_CHEST = GensokyoLegacy.loc("chests/hakurei_shrine/chest");
	public static final ResourceLocation SHRINE_BARREL = GensokyoLegacy.loc("chests/hakurei_shrine/barrel");
	public static final ResourceLocation SHRINE_CABINET = GensokyoLegacy.loc("chests/hakurei_shrine/cabinet");
*/

	public static final ResourceKey<LootTable> UDUMBARA_LOOT = loc("udumbara_chest_loot");

	public static final ResourceKey<LootTable> CRAB_SAND_BASE = loc("crab_digging/sand_base");
	public static final ResourceKey<LootTable> CRAB_SAND_RIVER = loc("crab_digging/sand_river");
	public static final ResourceKey<LootTable> CRAB_SAND_BEACH = loc("crab_digging/sand_beach");
	public static final ResourceKey<LootTable> CRAB_GRAVEL_BASE = loc("crab_digging/gravel_base");
	public static final ResourceKey<LootTable> CRAB_GRAVEL_RIVER = loc("crab_digging/gravel_river");
	public static final ResourceKey<LootTable> CRAB_GRAVEL_BEACH = loc("crab_digging/gravel_beach");

	private static ResourceKey<LootTable> loc(String str) {
		return ResourceKey.create(Registries.LOOT_TABLE, GensokyoLegacy.loc(str));
	}
