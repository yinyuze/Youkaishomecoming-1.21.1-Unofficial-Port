...
public class FleshSaucerItem extends BlockItem {

	public FleshSaucerItem(Block block, Properties props) {
		super(block, props);
	}
	...
	public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity consumer) {
		...
		if (remain.isEmpty()) return stack;
		if (stack.isEmpty()) return remain;
