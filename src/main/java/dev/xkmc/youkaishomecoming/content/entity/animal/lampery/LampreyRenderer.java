...
public class LampreyRenderer extends MobRenderer<LampreyEntity, LampreyModel<LampreyEntity>> {
	...
	public static final ResourceLocation TEX = GensokyoLegacy.loc("textures/entities/lamprey.png");
	...
	@Override
	protected void setupRotations(LampreyEntity pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float scale) {
