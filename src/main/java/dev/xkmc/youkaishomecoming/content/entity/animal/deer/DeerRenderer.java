...
public class DeerRenderer extends MobRenderer<DeerEntity, DeerModel> {
	...
	public static final ResourceLocation NORMAL = GensokyoLegacy.loc("textures/entities/deer/deer.png");
	public static final ResourceLocation FALLOW = GensokyoLegacy.loc("textures/entities/deer/fallow_deer.png");
	public static final ResourceLocation SAKURA = GensokyoLegacy.loc("textures/entities/deer/sakura_deer.png");
	public static final ResourceLocation WHITELIPPED = GensokyoLegacy.loc("textures/entities/deer/whitelipped_deer.png");
