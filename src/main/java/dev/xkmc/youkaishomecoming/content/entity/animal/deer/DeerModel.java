...
public class DeerModel extends AgeableHierarchicalModel<DeerEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(GensokyoLegacy.loc("deer"), "main");
	...
	public void setupAnim(DeerEntity e, float limbSw, float limbSA, float tick, float yrot, float xrot) {
		...
		if (e.prop.isPanic()) {
			...
			this.animateWalk(DeerModelData.WALK, limbSw, limbSA, 3f, 2.5f);
		}
