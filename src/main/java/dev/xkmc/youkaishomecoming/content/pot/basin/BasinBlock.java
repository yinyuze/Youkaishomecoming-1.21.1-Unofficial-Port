...
public class BasinBlock implements FallOnBlockMethod, ShapeBlockMethod, UseItemOnBlockMethod, UseWithoutItemBlockMethod {
	...
	public InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hit) {
		if (level.getBlockEntity(pos) instanceof BasinBlockEntity be) {
			if (player.isShiftKeyDown()) {
				...
				// 空手右键也应该能取出液体（用空瓶）
				var result = FluidItemTile.addFluidOrItem(be, ItemStack.EMPTY, level, pos, player, InteractionHand.MAIN_HAND, hit);
