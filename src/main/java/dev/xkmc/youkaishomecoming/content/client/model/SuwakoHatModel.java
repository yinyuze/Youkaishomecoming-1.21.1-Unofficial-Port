...
public class SuwakoHatModel {
	public static final ModelLayerLocation SUWAKO = new ModelLayerLocation(GensokyoLegacy.loc("suwako_hat"), "main");
	public static final ModelLayerLocation STRAW = new ModelLayerLocation(GensokyoLegacy.loc("straw_hat"), "main");
	...
	public static LayerDefinition createSuwakoHat() {
		MeshDefinition meshdefinition = HumanoidModel.createMesh(CubeDeformation.NONE, 0.0F);
		PartDefinition partdefinition = meshdefinition.getRoot().getChild("head");
		...
		PartDefinition rim = hat.addOrReplaceChild("rim", CubeListBuilder.create()
						.texOffs(0, 14)
						.addBox(-10.5F, 0.95F, -9.4F, 20.0F, 0.1F, 20.0F),
